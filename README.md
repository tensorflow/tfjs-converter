...
6. I have models converted with previous version of TensorFlow.js converter (0.15.x), they contain model file in .pb extension, how do I convert them into new json output format?
...
cd tfjs-converter
yarn
ts-node tools/pb2json_converter.ts pb_model_directory json_model_directory
```

`pb_model_directory` is the diretory where the model generated by previous version is located.
